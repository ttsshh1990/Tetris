...
TShape* TShape::createTShape()
{
    auto t = TShape::create();
    t->initBlock();
    return t;
}


void TShape::initBlock()
{
    fileName = "glass_purple.png";
    //b1
    ...
    //b4
    positions[12] = Vec2(1,2);
    positions[13] = Vec2(2,1);
    positions[14] = Vec2(1,0);
    positions[15] = Vec2(0,1);
